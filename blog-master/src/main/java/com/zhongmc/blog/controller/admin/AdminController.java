...
public class AdminController extends BaseController {
    ...
    public AdminLoginController.Message setTheme(){
        AdminLoginController.Message message = new AdminLoginController.Message();
    ...
    @ResponseBody
    public AdminLoginController.Message doSettings(Theme theme){
        AdminLoginController.Message message = new AdminLoginController.Message();
